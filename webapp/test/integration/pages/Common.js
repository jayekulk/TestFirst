sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/sap/products/offlineApp/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.sap.products.offlineApp.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/sap/products/offlineApp/localService/mockserver"], function (mockserver) {
